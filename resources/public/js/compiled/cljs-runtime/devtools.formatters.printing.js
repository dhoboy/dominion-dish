...
var len__4818__auto___28342 = arguments.length;
var i__4819__auto___28343 = (0);
while(true){
if((i__4819__auto___28343 < len__4818__auto___28342)){
args__4824__auto__.push((arguments[i__4819__auto___28343]));

var G__28344 = (i__4819__auto___28343 + (1));
i__4819__auto___28343 = G__28344;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4825__auto__);
});
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28280){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28281,G__28282,seq28280__$2);
}));
...
if(cljs.core.truth_((function (){var or__4212__auto__ = devtools.formatters.helpers.directly_printable_QMARK_(value);
if(or__4212__auto__){
...
(devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
if(cljs.core.truth_((function (){var and__4210__auto__ = cljs.core.not(devtools.formatters.printing.already_reference_QMARK_(group));
if(and__4210__auto__){
var or__4212__auto__ = devtools.formatters.helpers.expandable_QMARK_(obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28315_SHARP_){
return (!((cljs.core.meta(p1__28315_SHARP_) == null)));
})))){
...
var map__28320 = opts;
var map__28320__$1 = cljs.core.__destructure_map(map__28320);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28320__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__4212__auto__ = (function (){try{if((!((obj == null)))){
...
}catch (e28321){var _e__27558__auto__ = e28321;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e28324){var _e__27558__auto__ = e28324;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28331 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28332 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28332);

try{var map__28333 = opts;
var map__28333__$1 = cljs.core.__destructure_map(map__28333);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28333__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28331);
}});
...
var temp__5751__auto___28356 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___28356)){
var managed_print_level_28357 = temp__5751__auto___28356;
var _STAR_print_level_STAR__orig_val__28336_28358 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28337_28359 = managed_print_level_28357;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28337_28359);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28334_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28334_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28336_28358);
}} else {
job_fn();
}
