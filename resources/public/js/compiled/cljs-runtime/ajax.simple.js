...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__46595){
var map__46596 = p__46595;
var map__46596__$1 = cljs.core.__destructure_map(map__46596);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46596__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,new cljs.core.Keyword(null,"method","method",55703592),ajax.simple.normalize_method),new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),(function (p1__46605_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4212__auto__ = p1__46605_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__46620){
var map__46621 = p__46620;
var map__46621__$1 = cljs.core.__destructure_map(map__46621);
var request = map__46621__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46621__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__4212__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
