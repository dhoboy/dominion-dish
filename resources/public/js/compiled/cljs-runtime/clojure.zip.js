...
var G__38527 = clojure.zip.node(loc);
var fexpr__38526 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var G__38533 = clojure.zip.node(loc);
var fexpr__38532 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38532.cljs$core$IFn$_invoke$arity$1 ? fexpr__38532.cljs$core$IFn$_invoke$arity$1(G__38533) : fexpr__38532.call(null,G__38533));
} else {
...
var fexpr__38534 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38534.cljs$core$IFn$_invoke$arity$2 ? fexpr__38534.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__38534.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__38535 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38535,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38535,(1),null);
var vec__38538 = clojure.zip.children(loc);
...
var vec__38544 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38544,(0),null);
var map__38547 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38544,(1),null);
var map__38547__$1 = cljs.core.__destructure_map(map__38547);
var path = map__38547__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38547__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38547__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38547__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38547__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38547__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__38571 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38571,(0),null);
var map__38574 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38571,(1),null);
var map__38574__$1 = cljs.core.__destructure_map(map__38574);
var path = map__38574__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38574__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__38575 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38574__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__38576 = cljs.core.seq(vec__38575);
var first__38577 = cljs.core.first(seq__38576);
var seq__38576__$1 = cljs.core.next(seq__38576);
var r = first__38577;
var rnext = seq__38576__$1;
var rs = vec__38575;
...
var vec__38598 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38598,(0),null);
var map__38601 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38598,(1),null);
var map__38601__$1 = cljs.core.__destructure_map(map__38601);
var path = map__38601__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38601__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38601__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4210__auto__ = path;
if(cljs.core.truth_(and__4210__auto__)){
return r;
} else {
...
var vec__38604 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38604,(0),null);
var map__38607 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38604,(1),null);
var map__38607__$1 = cljs.core.__destructure_map(map__38607);
var path = map__38607__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38607__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38607__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4210__auto__ = path;
if(cljs.core.truth_(and__4210__auto__)){
...
var vec__38609 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38609,(0),null);
var map__38612 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38609,(1),null);
var map__38612__$1 = cljs.core.__destructure_map(map__38612);
var path = map__38612__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38612__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38612__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4210__auto__ = path;
if(cljs.core.truth_(and__4210__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__38616 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38616,(0),null);
var map__38619 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38616,(1),null);
var map__38619__$1 = cljs.core.__destructure_map(map__38619);
var path = map__38619__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38619__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__38620 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38620,(0),null);
var map__38623 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38620,(1),null);
var map__38623__$1 = cljs.core.__destructure_map(map__38623);
var path = map__38623__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38623__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__38624 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38624,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38624,(1),null);
...
var len__4818__auto___38667 = arguments.length;
var i__4819__auto___38668 = (0);
while(true){
if((i__4819__auto___38668 < len__4818__auto___38667)){
args__4824__auto__.push((arguments[i__4819__auto___38668]));

var G__38669 = (i__4819__auto___38668 + (1));
i__4819__auto___38668 = G__38669;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq38627){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38628,G__38629,seq38627__$2);
}));
...
var G__38689 = clojure.zip.rightmost(child);
loc__$1 = G__38689;
continue;
} else {
return loc__$1;
...
var vec__38641 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38641,(0),null);
var map__38644 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38641,(1),null);
var map__38644__$1 = cljs.core.__destructure_map(map__38644);
var path = map__38644__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38644__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38644__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38644__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38644__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__38704 = clojure.zip.rightmost(child);
loc__$1 = G__38704;
continue;
} else {
return loc__$1;
