...
var G__28272 = devtools.prefs.pref(v);
v = G__28272;
continue;
} else {
return v;
...
var and__4210__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__4210__auto__){
var and__4210__auto____$1 = (!(cljs.core.var_QMARK_(value)));
...
var or__4212__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e28216){var _e__27558__auto__ = e28216;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
var or__4212__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e28220){var _e__27558__auto__ = e28220;
return false;
}})();
...
}catch (e28223){var _e__27558__auto__ = e28223;
return false;
}}
}
});
...
var and__4210__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_(f)));
if(and__4210__auto____$1){
...
var or__4212__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
...
var and__4210__auto__ = (function (){var or__4212__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
...
var vec__28243 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28243,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28243,(1),null);
...
var and__4210__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__4210__auto__)){
...
return cljs.core.some((function (p1__28251_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28251_SHARP_);
}),template);
});
