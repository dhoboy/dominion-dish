...
var syms = (function (){var iter__4611__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__37902(s__37903){
return (new cljs.core.LazySeq(null,(function (){
var s__37903__$1 = s__37903;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__37903__$1);
if(temp__5753__auto__){
var s__37903__$2 = temp__5753__auto__;
...
var i = cljs.core._nth(c__4609__auto__,i__37904);
...
cljs.core.chunk_append(b__37905,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__38028 = (i__37904 + (1));
i__37904 = G__38028;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37905),rewrite_clj$node$fn$fn_walk_$_iter__37902(cljs.core.chunk_rest(s__37903__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37905),null);
}
} else {
var i = cljs.core.first(s__37903__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__37902(cljs.core.rest(s__37903__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__37901_SHARP_){
var or__4212__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__37901_SHARP_);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return p1__37901_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k37920,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k37920,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__37938){
var vec__37939 = p__37938;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37939,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37939,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__37919){
var self__ = this;
var G__37919__$1 = this;
return (new cljs.core.RecordIter((0),G__37919__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37921,other37922){
var self__ = this;
var this37921__$1 = this;
return (((!((other37922 == null)))) && ((((this37921__$1.constructor === other37922.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37921__$1.children,other37922.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37921__$1.__extmap,other37922.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k37920){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k37920);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__37919){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__37975 = cljs.core.keyword_identical_QMARK_;
var expr__37976 = k__4470__auto__;
if(cljs.core.truth_((pred__37975.cljs$core$IFn$_invoke$arity$2 ? pred__37975.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__37976) : pred__37975.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__37976)))){
return (new rewrite_clj.node.fn.FnNode(G__37919,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__37919),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__37919){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__37919,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__37923){
var extmap__4501__auto__ = (function (){var G__37996 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__37923,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__37923)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__37996);
} else {
return G__37996;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__37923),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
