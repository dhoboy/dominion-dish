 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__34184,right){
var map__34185 = p__34184;
var map__34185__$1 = cljs.core.__destructure_map(map__34185);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34185__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34185__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__34186 = temp__5753__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34186,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34186,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34186,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34189__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__34190 = u(y);
var map__34190__$1 = cljs.core.__destructure_map(map__34190);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34190__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__34214__delegate = function (x,y,more){
...
var G__34214 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__34215__i = 0, G__34215__a = new Array(arguments.length -  2);
while (G__34215__i < G__34215__a.length) {G__34215__a[G__34215__i] = arguments[G__34215__i + 2]; ++G__34215__i;}
  more = new cljs.core.IndexedSeq(G__34215__a,0,null);
} 
return G__34214__delegate.call(this,x,y,more);};
G__34214.cljs$lang$maxFixedArity = 2;
G__34214.cljs$lang$applyTo = (function (arglist__34216){
var x = cljs.core.first(arglist__34216);
arglist__34216 = cljs.core.next(arglist__34216);
var y = cljs.core.first(arglist__34216);
var more = cljs.core.rest(arglist__34216);
return G__34214__delegate(x,y,more);
});
...
var G__34217 = null;
if (arguments.length > 2) {
var G__34218__i = 0, G__34218__a = new Array(arguments.length -  2);
while (G__34218__i < G__34218__a.length) {G__34218__a[G__34218__i] = arguments[G__34218__i + 2]; ++G__34218__i;}
G__34217 = new cljs.core.IndexedSeq(G__34218__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__34217);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34191__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__34192 = u(y);
var map__34192__$1 = cljs.core.__destructure_map(map__34192);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34192__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__34222__delegate = function (x,y,more){
...
var G__34222 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__34224__i = 0, G__34224__a = new Array(arguments.length -  2);
while (G__34224__i < G__34224__a.length) {G__34224__a[G__34224__i] = arguments[G__34224__i + 2]; ++G__34224__i;}
  more = new cljs.core.IndexedSeq(G__34224__a,0,null);
} 
return G__34222__delegate.call(this,x,y,more);};
G__34222.cljs$lang$maxFixedArity = 2;
G__34222.cljs$lang$applyTo = (function (arglist__34225){
var x = cljs.core.first(arglist__34225);
arglist__34225 = cljs.core.next(arglist__34225);
var y = cljs.core.first(arglist__34225);
var more = cljs.core.rest(arglist__34225);
return G__34222__delegate(x,y,more);
});
...
var G__34226 = null;
if (arguments.length > 2) {
var G__34227__i = 0, G__34227__a = new Array(arguments.length -  2);
while (G__34227__i < G__34227__a.length) {G__34227__a[G__34227__i] = arguments[G__34227__i + 2]; ++G__34227__i;}
G__34226 = new cljs.core.IndexedSeq(G__34227__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__34226);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34193__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__34194 = u(y);
var map__34194__$1 = cljs.core.__destructure_map(map__34194);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34194__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__34229__delegate = function (x,y,more){
...
var G__34229 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__34230__i = 0, G__34230__a = new Array(arguments.length -  2);
while (G__34230__i < G__34230__a.length) {G__34230__a[G__34230__i] = arguments[G__34230__i + 2]; ++G__34230__i;}
  more = new cljs.core.IndexedSeq(G__34230__a,0,null);
} 
return G__34229__delegate.call(this,x,y,more);};
G__34229.cljs$lang$maxFixedArity = 2;
G__34229.cljs$lang$applyTo = (function (arglist__34231){
var x = cljs.core.first(arglist__34231);
arglist__34231 = cljs.core.next(arglist__34231);
var y = cljs.core.first(arglist__34231);
var more = cljs.core.rest(arglist__34231);
return G__34229__delegate(x,y,more);
});
...
G__34232 = new cljs.core.IndexedSeq(G__34233__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__34232);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34195__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__34196 = u(y);
var map__34196__$1 = cljs.core.__destructure_map(map__34196);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34196__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__34236__delegate = function (x,y,more){
...
var G__34236 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__34238__i = 0, G__34238__a = new Array(arguments.length -  2);
while (G__34238__i < G__34238__a.length) {G__34238__a[G__34238__i] = arguments[G__34238__i + 2]; ++G__34238__i;}
  more = new cljs.core.IndexedSeq(G__34238__a,0,null);
} 
return G__34236__delegate.call(this,x,y,more);};
G__34236.cljs$lang$maxFixedArity = 2;
G__34236.cljs$lang$applyTo = (function (arglist__34239){
var x = cljs.core.first(arglist__34239);
arglist__34239 = cljs.core.next(arglist__34239);
var y = cljs.core.first(arglist__34239);
var more = cljs.core.rest(arglist__34239);
return G__34236__delegate(x,y,more);
});
...
var G__34242 = null;
if (arguments.length > 2) {
var G__34243__i = 0, G__34243__a = new Array(arguments.length -  2);
while (G__34243__i < G__34243__a.length) {G__34243__a[G__34243__i] = arguments[G__34243__i + 2]; ++G__34243__i;}
G__34242 = new cljs.core.IndexedSeq(G__34243__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__34242);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
