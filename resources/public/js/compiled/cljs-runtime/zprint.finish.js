...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__37586_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__37586_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__37586_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__37588){
var vec__37589 = p__37588;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37589,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37589,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__37595,s,color,element,idx){
var map__37596 = p__37595;
var map__37596__$1 = cljs.core.__destructure_map(map__37596);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37596__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37596__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37596__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__37603 = (function (){var or__4212__auto__ = color;
...
var fexpr__37602 = (function (){var G__37604 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__37604) : style_map.call(null,G__37604));
})();
return (fexpr__37602.cljs$core$IFn$_invoke$arity$1 ? fexpr__37602.cljs$core$IFn$_invoke$arity$1(G__37603) : fexpr__37602.call(null,G__37603));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__37605){
var vec__37606 = p__37605;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37606,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37606,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37606,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__37609){
var vec__37610 = p__37609;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37610,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37610,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37610,(2),null);
...
if(doing_nil_QMARK_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),(function (){var or__4212__auto__ = last_elide;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
...
var G__37725 = cljs.core.next(ssv);
var G__37726 = (this_ssv == null);
var G__37727 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__37728 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__37725;
doing_nil_QMARK_ = G__37726;
last_elide = G__37727;
out = G__37728;
continue;
}
...
var vec__37616 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37616,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37616,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37616,(2),null);
...
var G__37731 = cljs.core.next(remaining_cvec);
var G__37732 = new_idx;
var G__37733 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__37731;
idx = G__37732;
out = G__37733;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__37628,cursor_vec){
var vec__37629 = p__37628;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37629,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37629,(1),null);
var focus_vec = vec__37629;
...
var vec__37632 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37632,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37632,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__37636){
var vec__37637 = p__37636;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37637,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37637,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__37645,existing_count){
var vec__37646 = p__37645;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37646,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37646,(1),null);
...
var cursor__$1 = (function (){var x__4298__auto__ = zprint.finish.floor((0),(len - (1)));
var y__4299__auto__ = cursor;
return ((x__4298__auto__ < y__4299__auto__) ? x__4298__auto__ : y__4299__auto__);
})();
return cljs.core.filterv((function (p1__37641_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__37641_SHARP_))));
...
var vec__37656 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37656,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37656,(1),null);
var cvec_element = vec__37656;
if((cvec_element == null)){
var G__37762 = cljs.core.next(cvec_nl);
var G__37763 = (idx + (1));
var G__37764 = start;
var G__37765 = out;
cvec_nl = G__37762;
...
if(cljs.core.truth_((function (){var and__4210__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n,(1));
...
var G__37766 = cljs.core.next(cvec_nl);
var G__37767 = (idx + (1));
var G__37768 = idx;
var G__37769 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__37766;
idx = G__37767;
start = G__37768;
out = G__37769;
...
var G__37770 = cljs.core.next(cvec_nl);
var G__37771 = (idx + (1));
var G__37772 = (idx + (1));
var G__37773 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__37770;
idx = G__37771;
start = G__37772;
out = G__37773;
...
var G__37774 = cljs.core.next(cvec_nl);
var G__37775 = (idx + (1));
var G__37776 = idx;
var G__37777 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__37774;
idx = G__37775;
start = G__37776;
out = G__37777;
...
var G__37778 = cljs.core.next(cvec_nl);
var G__37779 = (idx + (1));
var G__37780 = start;
var G__37781 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__37778;
idx = G__37779;
start = G__37780;
out = G__37781;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37660_SHARP_,p2__37659_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__37659_SHARP_)){
return cljs.core.reduced(p1__37660_SHARP_);
} else {
return (p1__37660_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__37663,p__37664){
var vec__37669 = p__37663;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37669,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37669,(1),null);
var vec__37672 = p__37664;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37672,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37672,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__37692,cvec,focus_vec){
var map__37693 = p__37692;
var map__37693__$1 = cljs.core.__destructure_map(map__37693);
var options = map__37693__$1;
var map__37694 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37693__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__37694__$1 = cljs.core.__destructure_map(map__37694);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37694__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37694__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37694__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37689_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__37689_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
