...
var G__38905 = (function (){var G__38906 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__38906) : f.call(null,G__38906));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__38905) : rewrite_clj.node.coerce.call(null,G__38905));
});
/**
...
var len__4818__auto___38956 = arguments.length;
var i__4819__auto___38957 = (0);
while(true){
if((i__4819__auto___38957 < len__4818__auto___38956)){
args__4824__auto__.push((arguments[i__4819__auto___38957]));

var G__38959 = (i__4819__auto___38957 + (1));
i__4819__auto___38957 = G__38959;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__38907_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__38907_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq38908){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38909,G__38910,seq38908__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__38936 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__38936) : str_fn.call(null,G__38936));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__38937 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__38937) : str_fn.call(null,G__38937));
})()):null)));
...
var G__38942 = rewrite_clj.zip.base.tag(zloc);
var G__38942__$1 = (((G__38942 instanceof cljs.core.Keyword))?G__38942.fqn:null);
switch (G__38942__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__38940_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38940_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__38941_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38941_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38942__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__38954 = rewrite_clj.zip.base.tag(zloc);
var G__38954__$1 = (((G__38954 instanceof cljs.core.Keyword))?G__38954.fqn:null);
switch (G__38954__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__38948_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38948_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38954__$1)].join('')));
