...
var G__35161 = o;
goog.object.set(G__35161,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__35186.cljs$lang$applyTo = (function (arglist__35189){
...
var G__35162 = o;
goog.object.set(G__35162,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__35195.cljs$lang$applyTo = (function (arglist__35198){
...
var G__35163 = props;
var G__35163__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35163,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35163);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35163__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__35169 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35169,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__35169;
}
})(),id_class);
...
var G__35170 = (cljs.core.count(argv) - first_child);
switch (G__35170) {
case (0):
...
var vec__35171 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35171,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35171,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35171,(2),null);
...
var temp__5757__auto___35216 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___35216 == null)){
} else {
var key_35217 = temp__5757__auto___35216;
(jsprops.key = key_35217);
}
...
var temp__5757__auto___35219 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___35219 == null)){
} else {
var key_35220 = temp__5757__auto___35219;
(jsprops.key = key_35220);
}
...
var temp__5757__auto___35221 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___35221 == null)){
} else {
var key_35222 = temp__5757__auto___35221;
(jsprops.key = key_35222);
}
...
var temp__5757__auto___35223 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___35223 == null)){
} else {
var key_35224 = temp__5757__auto___35223;
(jsprops.key = key_35224);
}
...
var temp__5757__auto___35225 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___35225 == null)){
} else {
var key_35226 = temp__5757__auto___35225;
(jsprops.key = key_35226);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35174_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__35174_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__35175 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35175,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35175,(1),null);
...
break;
default:
var G__35230 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__35231 = compiler;
v = G__35230;
compiler = G__35231;
continue;
...
var G__35179 = tag;
var G__35179__$1 = (((G__35179 instanceof cljs.core.Keyword))?G__35179.fqn:null);
switch (G__35179__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template35181 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template35181 = (function (opts,id,fn_to_element,parse_fn,meta35182){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta35182 = meta35182;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template35181.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_35183,meta35182__$1){
var self__ = this;
var _35183__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template35181(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta35182__$1));
}));

(reagent.impl.template.t_reagent$impl$template35181.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_35183){
var self__ = this;
var _35183__$1 = this;
return self__.meta35182;
}));

(reagent.impl.template.t_reagent$impl$template35181.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template35181.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template35181.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template35181.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template35181.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template35181.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta35182","meta35182",-2014919511,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template35181.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template35181.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template35181");

(reagent.impl.template.t_reagent$impl$template35181.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template35181");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template35181.
 */
reagent.impl.template.__GT_t_reagent$impl$template35181 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template35181(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta35182){
return (new reagent.impl.template.t_reagent$impl$template35181(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta35182));
});

}

return (new reagent.impl.template.t_reagent$impl$template35181(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
