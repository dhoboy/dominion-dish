...
var G__38965 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__38965__$1 = (((G__38965 == null))?null:cljs.core.iterate((function (loc){
...
var G__38965__$2 = (((G__38965__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__38965__$1));
var G__38965__$3 = (((G__38965__$2 == null))?null:cljs.core.last(G__38965__$2));
if((G__38965__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__38965__$3);
}
} else {
return zloc;
}
...
var G__38987 = rewrite_clj.zip.move.right(v);
var G__38988 = rewrite_clj.zip.move.up(v);
loc = G__38987;
parent = G__38988;
continue;
} else {
var G__38989 = rewrite_clj.zip.move.right(v0);
var G__38990 = parent;
loc = G__38989;
parent = G__38990;
continue;
...
var G__38991 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__38992 = rewrite_clj.zip.move.up(v);
loc = G__38991;
parent = G__38992;
continue;
} else {
var G__38993 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__38994 = parent;
loc = G__38993;
parent = G__38994;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__38985 = zloc;
var G__38985__$1 = (((G__38985 == null))?null:rewrite_clj.zip.move.down(G__38985));
var G__38985__$2 = (((G__38985__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__38985__$1,k));
if((G__38985__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__38985__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__38986 = rewrite_clj.zip.move.down(zloc);
var G__38986__$1 = (((G__38986 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__38986));
if((G__38986__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__38986__$1);
}
})(),k);
}
});
