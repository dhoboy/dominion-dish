...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__46457){
var map__46458 = p__46457;
var map__46458__$1 = cljs.core.__destructure_map(map__46458);
var request = map__46458__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46458__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__46462 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__46462.cljs$core$IFn$_invoke$arity$1 ? fexpr__46462.cljs$core$IFn$_invoke$arity$1(response) : fexpr__46462.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__46464 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__46464.cljs$core$IFn$_invoke$arity$1 ? fexpr__46464.cljs$core$IFn$_invoke$arity$1(response) : fexpr__46464.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__46466){
var map__46468 = p__46466;
var map__46468__$1 = cljs.core.__destructure_map(map__46468);
var request = map__46468__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46468__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
