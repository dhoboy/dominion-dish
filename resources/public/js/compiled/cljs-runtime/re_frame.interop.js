...
return [(function (){var pred__35293 = cljs.core.instance_QMARK_;
var expr__35294 = reactive_val;
if(cljs.core.truth_((pred__35293.cljs$core$IFn$_invoke$arity$2 ? pred__35293.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__35294) : pred__35293.call(null,reagent.ratom.RAtom,expr__35294)))){
return "ra";
} else {
if(cljs.core.truth_((pred__35293.cljs$core$IFn$_invoke$arity$2 ? pred__35293.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__35294) : pred__35293.call(null,reagent.ratom.RCursor,expr__35294)))){
return "rc";
} else {
if(cljs.core.truth_((pred__35293.cljs$core$IFn$_invoke$arity$2 ? pred__35293.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__35294) : pred__35293.call(null,reagent.ratom.Reaction,expr__35294)))){
return "rx";
} else {
if(cljs.core.truth_((pred__35293.cljs$core$IFn$_invoke$arity$2 ? pred__35293.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__35294) : pred__35293.call(null,reagent.ratom.Track,expr__35294)))){
return "tr";
} else {
return "other";
}
