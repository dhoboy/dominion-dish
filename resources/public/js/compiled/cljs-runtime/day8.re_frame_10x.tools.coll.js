...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__36032_SHARP_,p2__36031_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__36031_SHARP_) : pred.call(null,p2__36031_SHARP_)))){
return p1__36032_SHARP_;
} else {
return null;
}
}),v);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__36033_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__36033_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__36033_SHARP_) <= ending)));
}));
});
/**
 ...
 */
day8.re_frame_10x.tools.coll.dissoc_in = (function day8$re_frame_10x$tools$coll$dissoc_in(m,p__36036){
var vec__36037 = p__36036;
var seq__36038 = cljs.core.seq(vec__36037);
var first__36039 = cljs.core.first(seq__36038);
var seq__36038__$1 = cljs.core.next(seq__36038);
var k = first__36039;
var ks = seq__36038__$1;
var keys = vec__36037;
if(ks){
