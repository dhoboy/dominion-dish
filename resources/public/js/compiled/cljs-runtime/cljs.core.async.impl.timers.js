...
(cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"cljs.core.async.impl.timers/SkipListNode");
}));
...
var i_43435 = (0);
while(true){
if((i_43435 < arr.length)){
(arr[i_43435] = null);

var G__43436 = (i_43435 + (1));
i_43435 = G__43436;
continue;
} else {
}
...
var i_43455 = (self__.level + (1));
while(true){
if((i_43455 <= (new_level + (1)))){
(update[i_43455] = self__.header);

var G__43456 = (i_43455 + (1));
i_43455 = G__43456;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43458 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43458[i]));
} else {
x__$2.forward.push((((i < links_43458.length))?(links_43458[i]):null));
}

if((i < links_43458.length)){
(links_43458[i] = x__$2);
} else {
links_43458.push(x__$2);
}
...
var i_43464 = (0);
while(true){
if((i_43464 <= self__.level)){
var links_43465 = (update[i_43464]).forward;
if((x__$1 === (((i_43464 < links_43465.length))?(links_43465[i_43464]):null))){
(links_43465[i_43464] = (x__$1.forward[i_43464]));

var G__43469 = (i_43464 + (1));
i_43464 = G__43469;
continue;
} else {
var G__43470 = (i_43464 + (1));
i_43464 = G__43470;
continue;
}
} else {
...
var G__43476 = nx;
var G__43477 = (level__$1 - (1));
x = G__43476;
level__$1 = G__43477;
continue;
} else {
var G__43479 = x;
var G__43480 = (level__$1 - (1));
x = G__43479;
level__$1 = G__43480;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__43488 = nx;
var G__43489 = (level__$1 - (1));
x = G__43488;
level__$1 = G__43489;
continue;
} else {
var G__43490 = x;
var G__43491 = (level__$1 - (1));
x = G__43490;
level__$1 = G__43491;
continue;
}
...
(cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"cljs.core.async.impl.timers/SkipList");
}));
...
var or__4212__auto__ = (cljs.core.truth_((function (){var and__4210__auto__ = me;
